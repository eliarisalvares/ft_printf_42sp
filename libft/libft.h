...
/*   Updated: 2021/10/05 19:01:55 by elraira-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param base, the base to be converted to (ex: decimal, hexadecimal, etc.)
 * @return char*, ,the string representing the int. NULL if allocation fails.
 */
